                                    ...
                                    <tr>
                                        <td class="product-info">
                                            ...
                                            <div>
                                                ...
                                                <span class="sku-title">{{ $item->product->title }}</span>
                                            </div>
                                        ...
                                        <td class="vertical-middle">
                                            ...
                                            @else
                                                <ul class="rate-area">
                                                    ...
                                                    <input type="radio" id="4-star-{{$index}}" name="reviews[{{$index}}][rating]" value="4" checked><label for="4-star-{{$index}}"></label>
                                                    <input type="radio" id="3-star-{{$index}}" name="reviews[{{$index}}][rating]" value="3" checked><label for="3-star-{{$index}}"></label>
                                                    <input type="radio" id="2-star-{{$index}}" name="reviews[{{$index}}][rating]" value="2" checked><label for="2-star-{{$index}}"></label>
                                                    <input type="radio" id="1-star-{{$index}}" name="reviews[{{$index}}][rating]" value="1" checked><label for="1-star-{{$index}}"></label>
                                                </ul>
                                            @endif
                                        </td>
                                        <td>
                                            ...
                                            @else
                                                ...
                                                @if($errors->has('reviews.'.$index.'.review'))
                                                    @foreach($errors->get('reviews.'.$index.'.review') as $msg)
                                                        <span class="invalid-feedback"><strong>{{ $msg }}</strong></span>
                                                    @endforeach
                                                @endif
                                            @endif
                                        </td>
